...
function About() {
    return (
        <section className="relative min-h-screen w-full overflow-hidden">
            ...
            <div className="absolute bottom-1/3 -right-32 w-96 h-96 bg-indigo-500/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "1s" }} />
                ...
                <div className="flex flex-col lg:flex-row gap-16 max-w-7xl mx-auto items-center">
                    ...
                    >
                        <div className="relative w-64 h-64 lg:w-80 lg:h-80 duration-1000 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                            {/* Front Side */}
                            <div className="absolute inset-0 rounded-full overflow-hidden border-4 border-indigo-500/30 shadow-2xl shadow-indigo-500/20 [backface-visibility:hidden]">
                                <img src={pp} alt="Profile Picture" className="w-full h-full object-cover" />
                                <div className="absolute inset-0 bg-gradient-to-t from-zinc-950/60 via-transparent to-transparent" />
                            </div>
                            {/* Back Side */}
                            <div className="absolute inset-0 bg-gradient-to-br from-sky-600/90 to-blue-600/90 backdrop-blur-sm rounded-full flex flex-col justify-center items-center p-8 text-center [transform:rotateY(180deg)] [backface-visibility:hidden] border-4 border-white/20">
                    ...
                    <div className="flex-1 flex flex-col gap-8 min-w-[250px] max-w-2xl">
                        <motion.span 
                            className="text-sm font-mono text-sky-400 tracking-widest uppercase"
                        ...
                        <motion.h1 
                            className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold bg-gradient-to-r from-white via-zinc-300 to-zinc-500 bg-clip-text text-transparent"
                        ...
                        >
                            {[
                                ...
                                <div 
                                    key={stat.label}
                                    className="group relative bg-zinc-800/50 backdrop-blur-sm border border-zinc-700/50 rounded-xl px-6 py-4 hover:border-indigo-500/50 transition-all duration-300"
                                >
